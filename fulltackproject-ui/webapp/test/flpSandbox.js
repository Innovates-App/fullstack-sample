		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#fulltackprojectui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fulltackprojectui-display": {
								"semanticObject": "fulltackprojectui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fulltackprojectui",
									"url": sap.ui.require.toUrl("fulltackprojectui")
								}
							}
						}
					}
